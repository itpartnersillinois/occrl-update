module.exports = (function (eleventyConfig) {
  ...
  eleventyConfig.addFilter("createMenu", function (title, menu) {
    ...
    if (currentUrl == '') {
      returnValue += `<a aria-label="Share on email" title="Share on email" href="mailto:?subject=https://update.occrl.illinois.edu/" rel="external"><ilw-icon type="solid" icon="email"></ilw-icon></a>`;
      ...
      returnValue += `<a aria-label="Share on email" title="Share on email" href="mailto:?subject=https://update.occrl.illinois.edu/${currentUrl}/index.html" rel="external"><ilw-icon type="solid" icon="email"></ilw-icon></a>`;
